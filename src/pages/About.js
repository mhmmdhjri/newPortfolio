            ...
            <div className="about-container">
              ...
              <span className="span-tag content">{'<p>'}</span>
                <p className="text-about">
                  Hi, I'm <span className="span-highlight">Muhammad Hijri</span>, a student at IDN Boarding School Pamijahan Bogor in majority of Software Enggineering <span className="span-highlight">Full-Stack Web Development</span>, I find joy in overcoming challenges through coding.
                </p>
                <p className="text-about">
